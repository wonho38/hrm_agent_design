...
class GaussOAPI:
    def __init__(self, access_key: str, secret_key: str):
        ...
        """
        self.base_url = "https://inference-webtrial-api.shuttle.sr-cloud.com/gausso-owl-ultra-instruct/v1"
...
def main():
    ...
    # API 클라이언트 초기화
    client = GaussOAPI(access_key, secret_key)
